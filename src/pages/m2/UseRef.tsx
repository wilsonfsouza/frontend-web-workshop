...
export function UseRef() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">useRef</h2>
      ...
      <ExampleCard title="DOM Access" description="useRef gives direct access to a DOM element.">
        <div className="flex gap-2">
          ...
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-900 text-sm"
          />
          <button
            onClick={focusInput}
