...
export const steps: Step[] = [
  ...
  },
  {
    ...
    card: "p-6 bg-white dark:bg-gray-900 space-y-4",
    avatar: "",
    header: "",
    name: "",
    title: "",
  ...
  },
  {
    ...
    card: "p-6 bg-white dark:bg-gray-900 space-y-4 border border-gray-200 dark:border-gray-700 rounded-lg",
    avatar: "",
    header: "",
    name: "",
    title: "",
  ...
  },
  {
    ...
    location: "text-sm text-gray-400 dark:text-gray-500",
    bio: "text-gray-700 dark:text-gray-300 leading-relaxed",
    skillContainer: "",
    skill: "",
    buttonRow: "",
    primaryBtn: "",
  ...
  },
  {
    ...
    skill:
      "px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200",
    buttonRow: "",
    primaryBtn: "",
    secondaryBtn: "",
  },
  {
    ...
    secondaryBtn:
      "px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 transition-colors",
  },
  {
    id: 7,
    ...
    card: "p-6 bg-white dark:bg-gray-900 space-y-4 border border-gray-200 dark:border-gray-700 rounded-lg transition-shadow hover:shadow-md",
