    ...
    <div>
      ...
      <IssueList issues={issues} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
            <div className="p-2.5 bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800 rounded text-emerald-800 dark:text-emerald-200">
            ...
            <div className="p-2.5 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded text-red-800 dark:text-red-200">
...
export function SearchInput() {
  ...
  return (
    ...
    />
          ...
          <div className="p-3 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded text-xs text-amber-800 dark:text-amber-200 space-y-1">
          ...
          <div className="p-2.5 bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded text-xs text-red-800 dark:text-red-200">
    ...
    <header>
      ...
      <button onClick={() => setTheme(
        ...
        {theme === "light" ? "🌙" : "☀️"}
            ...
            <div className="border border-emerald-200 dark:border-emerald-800 rounded-lg p-3">
  ...
  return (
    <ClientWrapper>
      <ServerContent />
          ...
          <div className="p-3 bg-gray-50 dark:bg-gray-900 rounded text-xs text-gray-600 dark:text-gray-400 font-mono leading-relaxed">
            <p className="text-gray-900 dark:text-gray-100 font-sans font-medium text-xs mb-1">
              How it works:
            </p>
